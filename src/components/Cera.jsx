const Cera = () => {
  const producto = {
    nombre: "Cera",
    descripcion:
      "Cera moldeadora con acabado natural. Controla el frizz y permite reestilizar durante el día.",
    imagen: "/img/cera.jpg",
    aromas: ["Vainilla", "Sándalo", "Coco"],
  };
        ...
        <div className="w-full md:w-1/2 text-gray-700">
          ...
          <a
            href={`https://wa.me/+5492235950860?text=${encodeURIComponent(
              `Hola Abuelo Mario, quiero solicitar la ${producto.nombre}`
            )}`}
            target="_blank"
