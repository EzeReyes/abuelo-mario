const ShavingGel = () => {
  const producto = {
    nombre: "Shaving Gel",
    descripcion:
      "Gel transparente que permite un afeitado preciso y suave. Refresca la piel y reduce la irritación.",
    imagen: "/img/shaving-gel.jpg",
    aromas: ["Eucalipto", "Aloe Vera", "Mentol"],
  };
