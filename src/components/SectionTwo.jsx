...
const SectionTwo = () => {
    ...
    const clientes = [
        {
            ...
            image:
                "https://ezereyes.github.io/PreEntrega2Reyes/pages/img/quienes/22.jpeg",
        ...
        },
        {
            ...
            image:
                "https://ezereyes.github.io/PreEntrega2Reyes/pages/img/quienes/33.jpg",
    ...
    return (
        <section
        ref={sectionRef}
            className={`px-6 md:px-16 py-12 shadow-2xl bg-gradient-to-br from-yellow-100 via-neutral-300 to-neutral-500 transition-all duration-1000 ease-out transform ${
